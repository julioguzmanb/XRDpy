"""
SPring-8 / SACLA azimuthal-integration API for XRDpy.
...
Implementation note
-------------------
The actual implementation lives in :mod:`XRDpy.analysis._shared_2d.azimint`.
...
- SACLA-specific reduction remains in :mod:`XRDpy.analysis.Spring8_SACLA.datared`.
- This wrapper exists so users can call:
    ``XRDpy.analysis.Spring8_SACLA.azimint...``
